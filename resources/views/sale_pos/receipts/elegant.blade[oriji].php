...
<div class="col-md-6 invoice-col width-50 ">
	...
	<div class="col-md-6 invoice-col width-50">
		...
		<div class="text-right font-23" style="font-size: 23px; text-transform: capitalize;">
			@if(!empty($receipt_details->invoice_no_prefix))
		...
		@if(!empty($receipt_details->total_due) && !empty($receipt_details->total_due_label))
			<div class="bg-light-blue-active text-right font-23 padding-5" style="font-size: 23px; text-transform: capitalize;">
...
<div class="row  mt-5">
	<div class="col-xs-12" style="width: 100%">
		<table class="table table-slim mb-12" style="width: 100%;">
			<thead>
				<tr style="background-color: #063970 !important; color: white !important; font-size: 20px !important" class="table-no-side-cell-border table-no-top-cell-border text-center">
					<td style="background-color: #063970 !important; color: white !important; !important">#</td>
					...
					@if($receipt_details->show_cat_code == 1)
						<td style="background-color: #063970 !important; color: white !important;">{{$receipt_details->cat_code_label}}</td>
					@endif
...
<div class="row invoice-info " style="page-break-inside: avoid !important">
	<div class="col-md-6 invoice-col width-50">
		...
		<b class="pull-left" style="width: 100%; padding-bottom: 60px; border-bottom: 2px dashed black">{{__('lang_v1.authorized_signatory')}}</b>
	</div>
	...
	<div class="col-md-6 invoice-col width-50">
		<table class="table-no-side-cell-border table-no-top-cell-border width-100 table-slim">
			<tbody>
				...
				<!-- Total -->
				<tr>
					<th style="background-color: #063970 !important; color: white !important; border: none; padding: 10px;" class="font-23">
						{!! $receipt_details->total_label !!}
					</th>
					<td class="text-right font-23 padding-10" style="background-color: #063970 !important; color: white !important; border: none; padding: 10px;">
